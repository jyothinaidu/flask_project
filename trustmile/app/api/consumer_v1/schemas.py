...
validators = {
    ('account_register', 'POST'): {'json': DefinitionsAccountregister},
    ('deliveries', 'POST'): {'json': DefinitionsAdddelivery},
    ('deliveries', 'DELETE'): {'json': {'properties': {'deliveryID': {'type': 'string'}}}},
    ('account_forgotPassword', 'POST'): {'json': DefinitionsAccountforgotpassword},
    ('account', 'PUT'): {'json': DefinitionsAccountupdate},
    ('account_resetPassword_resetToken', 'POST'): {'json': DefinitionsPasswordreset},
    ('account_password', 'POST'): {'json': DefinitionsPasswordupdate},
    ('deliveries_deliveryId', 'PUT'): {'json': DefinitionsDeliveryupdate},
    ('user_presence', 'POST'): {'json': DefinitionsUserpresence},
    ('feedback', 'POST'): {'json': DefinitionsFeedbackmessage},
    ('promotion_viewlist', 'GET'): {'json': DefinitionsPromotionviewlist},
    ('deliveries_recipientHandover_deliveryId', 'POST'): {'json': DefinitionsRecipienthandover},
    ('deliveries_delegate', 'POST'): {'json': DefinitionsDelegatedelivery},
    ('account_login', 'POST'): {'json': DefinitionsAccountlogin},
    ('deliveries_neighbourReceive_deliveryId', 'POST'): {'json': DefinitionsNeighbourreceive},
    ('promotion_click_promotionViewId', 'GET'): {'json': DefinitionsPromotionclick},
    ('account_anonymous_register', 'POST'): {'json': DefinitionsAnonymousregister},
    ('deliveries_feedback_deliveryId', 'POST'): {'json': DefinitionsDeliveryfeedback},
}

filters = {
    ('anonymous_tracking_courierSlug_trackingNumber', 'GET'): {200: {'headers': None, 'schema': {'properties': {'delivery': DefinitionsDeliveryinfo, 'correlationID': {'type': 'string'}}}}, 404: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}},
    ...
    ('deliveries_tracking_deliveryId', 'GET'): {200: {'headers': None, 'schema': {'properties': {'delivery': DefinitionsDeliveryinfo, 'correlationID': {'type': 'string'}}}}, 401: {'headers': None, 'schema': Definitions401}, 404: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}},
    ('account_reverifyEmail', 'PUT'): {200: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}, 409: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}, 401: {'headers': None, 'schema': Definitions401}},
    ('deliveries', 'POST'): {200: {'headers': None, 'schema': {'properties': {'deliveryId': {'type': 'string', 'format': 'uuid'}, 'correlationID': {'type': 'string'}}}}, 401: {'headers': None, 'schema': Definitions401}, 400: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}, 404: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}},
    ('deliveries', 'GET'): {200: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}, 'deliveries': {'items': DefinitionsDeliveryinfo, 'type': 'array'}}}}, 401: {'headers': None, 'schema': Definitions401}},
    ('deliveries', 'DELETE'): {200: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}, 401: {'headers': None, 'schema': Definitions401}, 400: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}, 404: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}},
    ...
    ('order_orderId', 'GET'): {200: {'headers': None, 'schema': {'properties': {'order': DefinitionsOrderinfo, 'correlationID': {'type': 'string'}}}}, 401: {'headers': None, 'schema': Definitions401}, 404: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}},
    ('account', 'PUT'): {200: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}, 401: {'headers': None, 'schema': Definitions401}, 422: {'headers': None, 'schema': {'properties': {'message': {'type': 'string'}, 'correlationID': {'type': 'string'}}}}},
    ...
    ('deliveries_delegateLink_deliveryId', 'GET'): {200: {'headers': None, 'schema': {'properties': {'delegateLink': {'type': 'string', 'format': 'url'}, 'correlationID': {'type': 'string'}}}}, 401: {'headers': None, 'schema': Definitions401}, 400: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}, 404: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}},
    ('deliveries_neighbourReceiveLookup_trackingNumber', 'GET'): {200: {'headers': None, 'schema': DefinitionsNeighbourreceivelookup}, 401: {'headers': None, 'schema': Definitions401}, 403: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}, 404: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}},
    ...
    ('deliveries_cardLookup_cardId', 'GET'): {200: {'headers': None, 'schema': DefinitionsNeighbourpickupinfo}, 401: {'headers': None, 'schema': Definitions401}, 404: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}},
    ('deliveries_deliveryId', 'PUT'): {200: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}, 401: {'headers': None, 'schema': Definitions401}, 400: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}, 404: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}},
    ('deliveries_deliveryId', 'GET'): {200: {'headers': None, 'schema': {'properties': {'delivery': DefinitionsDeliveryinfo, 'correlationID': {'type': 'string'}}}}, 401: {'headers': None, 'schema': Definitions401}, 404: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}},
    ('user_presence', 'POST'): {200: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}, 401: {'headers': None, 'schema': Definitions401}, 400: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}, 404: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}},
    ('deliveries_trustmile_deliveryId', 'GET'): {200: {'headers': None, 'schema': {'properties': {'delivery': DefinitionsTrustmiledeliveryinfo, 'correlationID': {'type': 'string'}}}}, 401: {'headers': None, 'schema': Definitions401}, 404: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}},
    ('feedback', 'POST'): {200: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}, 401: {'headers': None, 'schema': Definitions401}},
    ('deliveries_recipientHandover_deliveryId', 'POST'): {422: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}, 200: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}, 401: {'headers': None, 'schema': Definitions401}, 403: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}, 404: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}, 409: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}},
    ('deliveries_recipientHandover_deliveryId', 'DELETE'): {200: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}, 401: {'headers': None, 'schema': Definitions401}, 403: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}, 404: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}, 422: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}},
    ('deliveries_delegate', 'POST'): {200: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}, 401: {'headers': None, 'schema': Definitions401}, 400: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}, 404: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}},
    ('account_login', 'POST'): {200: {'headers': None, 'schema': {'properties': {'emailVerified': {'type': 'boolean'}, 'apiKey': {'type': 'string', 'format': 'uuid'}, 'userId': {'type': 'string', 'format': 'uuid'}, 'correlationID': {'type': 'string'}}}}, 403: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}},
    ('account_verifyEmail_verificationCode', 'GET'): {200: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}, 409: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}, 401: {'headers': None, 'schema': Definitions401}},
    ('deliveries_neighbourReceive_deliveryId', 'POST'): {200: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}, 401: {'headers': None, 'schema': Definitions401}, 403: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}, 404: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}, 422: {'headers': None, 'schema': None}},
    ('account_anonymous_register', 'POST'): {200: {'headers': None, 'schema': {'properties': {'apiKey': {'type': 'string', 'format': 'uuid'}, 'correlationID': {'type': 'string'}}}}, 409: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}, 400: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}},
    ('deliveries_feedback_deliveryId', 'POST'): {200: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}, 401: {'headers': None, 'schema': Definitions401}, 404: {'headers': None, 'schema': {'properties': {'correlationID': {'type': 'string'}}}}},
}

scopes = {
    ('anonymous_tracking_courierSlug_trackingNumber', 'GET'): [],
    ('deliveries_tracking_deliveryId', 'GET'): [],
    ('account_reverifyEmail', 'PUT'): [],
    ('deliveries', 'POST'): [],
    ('deliveries', 'GET'): [],
    ('order_orderId', 'GET'): [],
    ('account', 'PUT'): [],
    ('account', 'GET'): [],
    ('account', 'DELETE'): [],
    ('deliveries_delegateLink_deliveryId', 'GET'): [],
    ('deliveries_neighbourReceiveLookup_trackingNumber', 'GET'): [],
    ('account_password', 'POST'): [],
    ('deliveries_cardLookup_cardId', 'GET'): [],
    ('deliveries_deliveryId', 'PUT'): [],
    ('deliveries_deliveryId', 'GET'): [],
    ('user_presence', 'POST'): [],
    ('deliveries_trustmile_deliveryId', 'GET'): [],
    ('feedback', 'POST'): [],
    ('deliveries_recipientHandover_deliveryId', 'POST'): [],
    ('deliveries_recipientHandover_deliveryId', 'DELETE'): [],
    ('deliveries_delegate', 'POST'): [],
    ('account_verifyEmail_verificationCode', 'GET'): [],
    ('deliveries_neighbourReceive_deliveryId', 'POST'): [],
    ('deliveries_feedback_deliveryId', 'POST'): [],
}
